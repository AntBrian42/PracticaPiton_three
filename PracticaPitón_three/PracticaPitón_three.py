...
ventana = tk.Tk()
ventana.title("Actividad 03 - Conversor de Temperatura phyton")
...
groupBox.pack()
rbCelsius = tk.Radiobutton(groupBox, text="Celsius", value="Celsius",
variable=rbSeleccion, command=radioButton_Selected)
rbCelsius.grid(row=0, column=0)
rbKelvin = tk.Radiobutton(groupBox, text="Kelvin", value="Kelvin",
   variable=rbSeleccion, command=radioButton_Selected)
rbKelvin.grid(row=0, column=1)
rbFahrenheit = tk.Radiobutton(groupBox, text="Fahrenheit",
   value="Fahrenheit", variable=rbSeleccion,
command=radioButton_Selected)
rbFahrenheit.grid(row=0, column=2)
btnCalcular = tk.Button(ventana, text="Calcular",
   command=btnCalcular_Click)
btnCalcular.pack()
btnLimpiar = tk.Button(ventana, text="Limpiar",
